...
export let applications: Application[] = [
    {
        ...
        dob: "2009-03-22",
        gender: "Female",
        email: "almaz.ayana@example.et",
        phone: "+251-911-555-0182",
        address: "789 Pine St, Addis Ababa, Ethiopia",
        parent: "Hiwot Ayana",
        parentPhone: "+251-911-555-0183",
        documents: {
            birthCertificate: "almaz_ayana_birth_cert.pdf",
            birthCertificateUrl: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=",
        },
    ...
    },
    {
        ...
        phone: "+251-911-555-0121",
        address: "456 Oak Ave, Addis Ababa, Ethiopia",
        parent: "Mulugeta Bikila",
        parentPhone: "+251-911-555-0122",
        documents: {
            birthCertificate: "abebe_bikila_birth_cert.pdf",
            ...
            previousMarksheet: "abebe_bikila_marksheet.pdf",
        },
    },
    {
        id: "REG003",
        name: "Selamawit Degefu",
        class: "Kindergarten",
        date: "2024-08-12",
        status: "Completed",
        dob: "2019-11-05",
        gender: "Female",
        email: "selamawit.d@example.et",
        phone: "+251-911-555-0145",
        address: "321 Cedar Blvd, Addis Ababa, Ethiopia",
        parent: "Tsige Degefu",
        parentPhone: "+251-911-555-0146",
        documents: {
            birthCertificate: "selamawit_d_birth_cert.pdf",
        },
    },
];

export let students: Student[] = [
    { studentId: "S001", admissionNumber: "ADM001", name: "Tirunesh Dibaba", class: "Grade 10 - A", parent: "Robert Dibaba", status: "Active", email: "tirunesh.d@example.et", avatarUrl: placeholderImages.student1.url, dob: "2008-05-12", gender: "Female", address: "123 Maple Street, Addis Ababa, Ethiopia", enrollmentDate: "2022-04-01", medical: { allergies: ["Peanuts"], conditions: ["Asthma"], bloodGroup: "A+", emergencyContact: { name: "Robert Dibaba", relation: "Father", phone: "+251-911-555-0110" } }, motherTongue: "Amharic", region: "Addis Ababa", specialNeedsType: "None", isRefugee: false },
    { studentId: "S002", admissionNumber: "ADM002", name: "Kenenisa Bekele", class: "Grade 10 - B", parent: "Sarah Bekele", status: "Active", email: "kenenisa.b@example.et", avatarUrl: placeholderImages.student2.url, dob: "2008-02-18", gender: "Male", address: "456 Oak Avenue, Addis Ababa, Ethiopia", enrollmentDate: "2022-04-01", medical: { allergies: [], conditions: [], bloodGroup: "B-", emergencyContact: { name: "Sarah Bekele", relation: "Mother", phone: "+251-911-555-0111" } }, motherTongue: "Amharic", region: "Addis Ababa", specialNeedsType: "Physical Disability", isRefugee: false },
    { studentId: "S003", admissionNumber: "ADM003", name: "Haile Gebrselassie", class: "Grade 9 - A", parent: "Dawit Gebrselassie", status: "Active", email: "haile.g@example.et", avatarUrl: placeholderImages.student3.url, dob: "2009-09-30", gender: "Male", address: "789 Pine Lane, Addis Ababa, Ethiopia", enrollmentDate: "2021-04-01", medical: { allergies: ["Pollen"], conditions: [], bloodGroup: "O+", emergencyContact: { name: "Dawit Gebrselassie", relation: "Father", phone: "+251-911-555-0112" } }, motherTongue: "Amharic", region: "Addis Ababa", specialNeedsType: "None", isRefugee: true },
    { studentId: "S004", admissionNumber: "ADM004", name: "Meseret Defar", class: "Grade 11 - Science", parent: "Laura Defar", status: "Inactive", email: "meseret.d@example.et", avatarUrl: placeholderImages.student4.url, dob: "2007-11-22", gender: "Female", address: "101 Birch Road, Addis Ababa, Ethiopia", enrollmentDate: "2023-04-01", medical: { allergies: [], conditions: ["Diabetes"], bloodGroup: "AB+", emergencyContact: { name: "Laura Defar", relation: "Mother", phone: "+251-911-555-0113" } } },
    { studentId: "S005", admissionNumber: "ADM005", name: "Dawit Isaak", class: "Grade 12 - Commerce", parent: "James Isaak", status: "Active", email: "dawit.i@example.et", avatarUrl: placeholderImages.student5.url, dob: "2006-07-14", gender: "Male", address: "212 Elm Street, Addis Ababa, Ethiopia", enrollmentDate: "2024-04-01", medical: { allergies: [], conditions: [], bloodGroup: "A-", emergencyContact: { name: "James Isaak", relation: "Father", phone: "+251-911-555-0114" } } },
    { studentId: "S006", admissionNumber: "ADM006", name: "Letesenbet Gidey", class: "Grade 10 - A", parent: "Maria Gidey", status: "Active", email: "letesenbet.g@example.et", avatarUrl: placeholderImages.student6.url, dob: "2008-08-08", gender: "Female", address: "333 Willow Way, Addis Ababa, Ethiopia", enrollmentDate: "2022-04-01", medical: { allergies: ["Shellfish"], conditions: [], bloodGroup: "O-", emergencyContact: { name: "Maria Gidey", relation: "Mother", phone: "+251-911-555-0115" } } },
];

export let employees: Employee[] = [
    { employeeId: "E001", employeeCode: "EMP001", name: "Teferi Mekonnen", dob: "1980-01-01", gender: "Male", department: "Academics", designation: "Principal", dateOfJoining: "2015-08-01", email: "teferi.m@example.et", status: "Active", avatarUrl: placeholderImages.defaultUser.url, salary: 6000, health: { bloodType: "O+" } },
    { employeeId: "E002", employeeCode: "EMP002", name: "Zewditu Haile Selassie", dob: "1985-05-10", gender: "Female", department: "Academics", designation: "Science Teacher", dateOfJoining: "2018-07-15", email: "zewditu.h@example.et", status: "Active", avatarUrl: placeholderImages.defaultUser.url, salary: 4500, allowances: 500, deductions: 100, health: { bloodType: "A-" } },
    { employeeId: "E003", employeeCode: "EMP003", name: "Mulugeta Yilma", dob: "1990-02-20", gender: "Male", department: "Academics", designation: "Mathematics Teacher", dateOfJoining: "2019-01-20", email: "mulugeta.y@example.et", status: "Active", avatarUrl: placeholderImages.defaultUser.url, salary: 4500, health: { bloodType: "B+" } },
    { employeeId: "E004", employeeCode: "EMP004", name: "Tsegaye Gebremedhin", dob: "1988-11-30", gender: "Female", department: "Administration", designation: "HR Manager", dateOfJoining: "2020-03-10", email: "tsegaye.g@example.et", status: "OnLeave", avatarUrl: placeholderImages.defaultUser.url, salary: 5500, health: { bloodType: "AB-" } },
    { employeeId: "E005", employeeCode: "EMP005", name: "Afework Tekle", dob: "1992-09-05", gender: "Male", department: "Finance", designation: "Accountant", dateOfJoining: "2021-08-01", email: "afework.t@example.et", status: "Probation", avatarUrl: placeholderImages.defaultUser.url, salary: 3800, allowances: 200, deductions: 50, health: { bloodType: "O-" } },
    { employeeId: "E006", employeeCode: "EMP006", name: "Yared Zeleke", dob: "1975-06-15", gender: "Male", department: "Administration", designation: "Hostel Warden", dateOfJoining: "2010-02-01", email: "yared.z@example.et", status: "Active", avatarUrl: placeholderImages.defaultUser.url, salary: 3200, health: { bloodType: "A+" } },
    { employeeId: "E007", employeeCode: "EMP007", name: "Aster Aweke", dob: "1978-04-25", gender: "Female", department: "Administration", designation: "Hostel Warden", dateOfJoining: "2012-05-12", email: "aster.a@example.et", status: "Active", avatarUrl: placeholderImages.defaultUser.url, salary: 3200, health: { bloodType: "B+" } },
];

export let candidates: Candidate[] = [
    { candidateId: "C001", name: "Elias Melka", position: "Physics Teacher", stage: "Interview", appliedDate: "2024-08-20" },
    { candidateId: "C002", name: "Tizita Belay", position: "Librarian", stage: "Offer", appliedDate: "2024-08-18" },
    { candidateId: "C003", name: "Sileshi Demisse", position: "IT Administrator", stage: "Applied", appliedDate: "2024-09-01" },
    { candidateId: "C004", name: "Hamelmal Abate", position: "Physics Teacher", stage: "Shortlisted", appliedDate: "2024-08-25" },
    { candidateId: "C005", name: "Teddy Afro", position: "Librarian", stage: "Rejected", appliedDate: "2024-08-15" },
];

export let onboardingTasks: OnboardingTask[] = [
...
export let leavePolicies: LeavePolicy[] = [
...
export let studentLeaveRequests: StudentLeaveRequest[] = [
...
export let borrowRequests: BorrowRequest[] = [
...
export let transactions: Transaction[] = [
    { id: "PAY001", date: "2024-08-05", description: "Payment for INV001 (Alice Johnson)", type: "Income", amount: 1250.00, method: "Online" },
    { id: "PAY002", date: "2024-08-12", description: "Payment for INV003 (Charlie Brown)", type: "Income", amount: 1100.00, method: "Bank Transfer" },
    { id: "PAY003", date: "2024-08-01", description: "Library Book Sale", type: "Income", amount: 450.50, method: "Cash" },
    { id: "PAY004", date: "2024-08-20", description: "Transport Fees", type: "Income", amount: 8000.00, method: "Online" },
    { id: "EXP001", date: "2024-08-24", description: "Office Supplies Purchase", type: "Expense", amount: 350.75, method: "Card" },
    { id: "EXP002", date: "2024-08-23", description: "Electricity Bill - August", type: "Expense", amount: 1200.00, method: "Bank Transfer" },
    { id: "EXP003", date: "2024-08-31", description: "Staff Salaries - August", type: "Expense", amount: 25000.00, method: "Bank Transfer" },
    { id: "EXP004", date: "2024-08-15", description: "Campus Maintenance", type: "Expense", amount: 2500.00, method: "Cheque" },
]

export let feeStructures: FeeStructure[] = [
...
export let drivers: Driver[] = [
    { driverId: "D001", name: "Kassahun Abera", licenseNumber: "DL12345", phone: "+251-911-555-0101", status: "Active" },
    { driverId: "D002", name: "Yonas Tadesse", licenseNumber: "DL67890", phone: "+251-911-555-0102", status: "Active" },
    { driverId: "D003", name: "Dawit Kebede", licenseNumber: "DL54321", phone: "+251-911-555-0103", status: "On Leave" },
];
...
export let timetables: Record<number, TimetableSlot[]> = {
    1: [ // Grade 10 - A
...
export let assessmentResults: AssessmentResult[] = [
...
export let attendanceSummaries: AttendanceSummary[] = [
...
export let announcements: Announcement[] = [
    ...
    { id: 4, title: "Homework: Maths Chapter 5", date: "2024-09-05", postedBy: "Mr. Mulugeta Yilma", content: "Please complete exercises 5.1 and 5.2 from Chapter 5.", category: "Homework", dueDate: "2024-09-12" },
];
...
export let classes: ClassSection[] = [
...
export let hostelVisitors: HostelVisitor[] = [
    { visitorId: 'HV001', visitorName: 'Teferi Mekonnen Sr.', studentId: 'S001', checkInTime: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(), checkOutTime: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), status: 'Checked Out' },
    { visitorId: 'HV002', visitorName: 'Aster Bekele', studentId: 'S002', checkInTime: new Date(Date.now() - 30 * 60 * 1000).toISOString(), checkOutTime: null, status: 'Checked In' },
];
...
export let alumni: Alumni[] = [
    { alumniId: 'AL001', name: 'Elias Mulugeta', graduationYear: 2018, major: 'Computer Science', currentCompany: 'Ethio Telecom', currentPosition: 'Senior Engineer', email: 'elias.m@example.et', linkedinUrl: 'https://linkedin.com/in/elias-mulugeta', avatarUrl: 'https://picsum.photos/seed/alumni1/400/400' },
    { alumniId: 'AL002', name: 'Zewditu Haile', graduationYear: 2019, major: 'Business Administration', currentCompany: 'Commercial Bank of Ethiopia', currentPosition: 'Manager', email: 'zewditu.h@example.et', avatarUrl: 'https://picsum.photos/seed/alumni2/400/400' },
    { alumniId: 'AL003', name: 'Takele Uma', graduationYear: 2017, major: 'Civil Engineering', currentCompany: 'Midroc', currentPosition: 'Project Manager', email: 'takele.u@example.et', linkedinUrl: 'https://linkedin.com/in/takele-uma', avatarUrl: 'https://picsum.photos/seed/alumni3/400/400' },
];
...
export let clubMembers: ClubMember[] = [
...
export let infirmaryVisits: InfirmaryVisit[] = [
...
export let extracurricularEvents: ExtracurricularEvent[] = [
...
export let donations: Donation[] = [
    { donationId: 'DON001', donorName: 'Elias Mulugeta (Alumni)', campaign: 'Library Expansion', amount: 500, date: '2024-08-01' },
    { donationId: 'DON002', donorName: 'Anonymous', campaign: 'Scholarship Fund', amount: 1000, date: '2024-08-05' },
];

export let alumniEvents: AlumniEvent[] = [
...
export let vendors: Vendor[] = [
    { vendorId: 'VDR-001', name: 'Sheger Stationeries', contactPerson: 'Teferi Mekonnen', email: 'sales@sheger.et', phone: '+251-11-456-7890' },
    { vendorId: 'VDR-002', name: 'Megenagna Science Equip.', contactPerson: 'Zewditu Haile', email: 'contact@megenagna.et', phone: '+251-11-654-3210' },
];

export let purchaseOrders: PurchaseOrder[] = [
    { poId: 'PO-001', vendorId: 'VDR-001', orderDate: '2024-08-10', items: [{ itemId: 'INV-SP-001', quantity: 50 }], totalAmount: 275, status: 'Completed' },
    { poId: 'PO-002', vendorId: 'VDR-002', orderDate: '2024-08-20', items: [{ itemId: 'INV-LE-002', quantity: 10 }], totalAmount: 250, status: 'Ordered' },
    { poId: 'PO-003', vendorId: 'VDR-001', orderDate: '2024-09-01', items: [{ itemId: 'INV-SP-002', quantity: 20 }], totalAmount: 240, status: 'Approved' },
    { poId: 'PO-004', vendorId: 'VDR-001', orderDate: '2024-09-05', items: [{ itemId: 'INV-SP-001', quantity: 100 }], totalAmount: 550, status: 'Pending' },
];

export let assetAllocations: AssetAllocation[] = [
...
export let disciplinaryRecords: DisciplinaryRecord[] = [
    { recordId: 'DR001', studentId: 'S002', date: '2024-09-05', incident: 'Uniform violation - incorrect shoes.', actionTaken: 'Verbal warning given.', reportedBy: 'Mr. Teferi Mekonnen', severity: 'Low' },
    { recordId: 'DR002', studentId: 'S005', date: '2024-09-02', incident: 'Disruptive behavior in library.', actionTaken: 'Detention assigned for 1 hour.', reportedBy: 'Mrs. Zewditu', severity: 'Medium' },
];

export let subscriberLists: SubscriberList[] = [
...
export const addPurchaseOrder = (orderData: Omit<PurchaseOrder, 'poId' | 'status' | 'orderDate' | 'totalAmount'>) => {
    ...
    const itemDetails = orderData.items.map(item => {
        const detail = inventoryItems.find(i => i.itemId === item.itemId);
        return { ...item, price: detail?.purchasePrice || 0 };
    });
