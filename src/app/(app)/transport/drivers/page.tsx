...
import { getDrivers, getRoutes, addDriver, type Driver } from "@/app/lib/data"
...
export default function DriversPage() {
  const [drivers, setDrivers] = React.useState(getDrivers());
  ...
  const handleAddDriver = (data: Omit<Driver, 'driverId' | 'status'>) => {
    addDriver(data);
